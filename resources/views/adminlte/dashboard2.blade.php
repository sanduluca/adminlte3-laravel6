                  ...
                  <div class="card-body">
                    ...
                    <div class="direct-chat-messages">
                      ...
                      <div class="direct-chat-msg">
                        ...
                        <!-- /.direct-chat-infos -->
                        <img class="direct-chat-img" src="{{asset('img/user4-128x128.jpg')}}" alt="message user image">
                        <!-- /.direct-chat-img -->
                    ...
                    <div class="direct-chat-contacts">
                      <ul class="contacts-list">
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="{{asset('img/user4-128x128.jpg')}}">
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tbody>
                    <tr>
                      <td><a href="{{ route('page-invoice') }}">OR9842</a></td>
                    ...
                    <tr>
                      <td><a href="{{ route('page-invoice') }}">OR1848</a></td>
                    ...
                    <tr>
                      <td><a href="{{ route('page-invoice') }}">OR7429</a></td>
                      <td>iPhone 6 Plus</td>
...
<script src="{{ asset(config('assets.plugin.jquery-mousewheel.js')) }}"></script>
<script src="{{ asset(config('assets.plugin.raphael.js')) }}"></script>
<script src="{{ asset(config('assets.plugin.jquery-mapael.js')) }}"></script>
<script src="{{ asset(config('assets.plugin.jquery-mapael.maps.usa_states')) }}"></script>
