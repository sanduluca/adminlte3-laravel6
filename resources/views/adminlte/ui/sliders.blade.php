...
<link rel="stylesheet" href="{{ asset(config('assets.plugin.ion-rangeslider.css')) }}" />
<link rel="stylesheet" href="{{ asset(config('assets.plugin.bootstrap-slider.css')) }}" />
...
<script src="{{ asset(config('assets.plugin.bootstrap-slider.js'))}}"></script>
<script src="{{ asset(config('assets.plugin.ion-rangeslider.js'))}}"></script>
