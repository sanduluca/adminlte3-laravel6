...
<link rel="stylesheet" href="{{ asset(config('assets.plugin.sweetalert2-theme-bootstrap-4.css')) }}" />
<link rel="stylesheet" href="{{ asset(config('assets.plugin.toastr.css')) }}" />
...
<!-- Scripts -->
<script src="{{ asset(config('assets.plugin.sweetalert2.js'))}}"></script>
<script src="{{ asset(config('assets.plugin.toastr.js'))}}"></script>
      ...
      $(function () {
        ...
        $('.toastsDefaultFullImage').click(function () {
          $(document).Toasts('create', {
            ...
            title: 'Toast Title',
            subtitle: 'Subtitle',
            image: '{{asset('img/user3-128x128.jpg')}}',
