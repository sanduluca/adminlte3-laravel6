...
@section('page-stylesheet')
    <link rel="stylesheet" href="{{ asset(config('assets.plugin.ekko-lightbox.css')) }}" />
@endsection
...
<!-- Scripts -->
<script src="{{ asset(config('assets.plugin.ekko-lightbox.js')) }}"></script>
<script src="{{ asset('js/adminlte.min.js')}}"></script>

<script src="{{ asset(config('assets.plugin.filterizr.js')) }}"></script>
<script>
      $(function () {
